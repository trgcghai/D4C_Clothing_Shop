...
public class CartController {
    ...
    public ResponseEntity<CheckoutResponse> checkout(@RequestHeader("X-User-Id") Long userId) {
    ...
    public ResponseEntity<Void> clearCartAfterCheckout(@RequestHeader("X-User-Id") Long userId) {
